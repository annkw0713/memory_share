document.addEventListener('turbolinks:load', function() {
  ...
  const buildNewFileField = () => {
    ...
    newFileField.setAttribute('name', 'memory[images][]');

    // 最後のfile_fieldを取得
    const lastFileField = document.querySelector('input[type="file"][name="memory[images][]"]:last-child');
  ...
  // input要素を取得
  const fileField = document.querySelector('input[type="file"][name="memory[images][]"]');
